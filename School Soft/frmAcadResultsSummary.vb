...
Public Class frmAcadResultsSummary
    ...
    Private Function CalculateMeans(ByVal tableName As String, ByVal className As String) As List(Of String)
    ...
    Private Sub btnPreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPreview.Click
        ...
        Try
            ...
            If Me.rbnbroadstream.Checked = True Then
                ...
                returnedAverages = CalculateMeans("tblTempERSumMarkStream1", Me.cboClass.Text.Trim)
                ...
                DirectCast(RptResultsView.ReportDefinition.ReportObjects("meanMark"), TextObject).Text = returnedAverages.Item(0)
                DirectCast(RptResultsView.ReportDefinition.ReportObjects("meanGrade"), TextObject).Text = returnedAverages.Item(1)
